...
class CircularSequence {
 ...
 public:
  ...
  class Iterator {
   ...
   public:
    Iterator(CircularSequence* s, int start) : seq(s), idx(start) {}
  ...
  int indexOfElement(const T& e) const { return indexOf(e); }
...
int main() {
  ...
  cout << "Index of 20: " << seq.indexOfElement(20) << endl;
  cout << "Position of 30: " << seq.positionOfElement(30) << endl;
  cout << "Index of 40: " << seq.indexOfElement(40) << endl;
  cout << "Position of 40: " << seq.positionOfElement(40) << endl;
